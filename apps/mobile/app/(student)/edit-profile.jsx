        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput style={styles.input} value={mobile} onChangeText={setMobile} placeholder="Enter mobile number" placeholderTextColor="#94a3b8" keyboardType="phone-pad" />
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  formCard: { backgroundColor: '#fff', marginHorizontal: 16, borderRadius: 24, padding: 24, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.05, shadowRadius: 10, elevation: 3, borderWidth: 1, borderColor: '#e2e8f0', marginTop: 10 },
  ...
  saveButton: { backgroundColor: '#1458b8', borderRadius: 12, paddingVertical: 16, alignItems: 'center', marginTop: 10, shadowColor: '#1458b8', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 4 },
  ...
  forgotPasswordButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', padding: 18, borderRadius: 16, borderWidth: 1, borderColor: '#e2e8f0' },
