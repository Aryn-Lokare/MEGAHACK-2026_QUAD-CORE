...
const styles = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 12, margin: 20, padding: 6, borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  avatarItem: { width: COLUMN_WIDTH, height: COLUMN_WIDTH, margin: 5, borderRadius: 16, backgroundColor: '#fff', borderWidth: 2, borderColor: 'transparent', overflow: 'hidden', elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4 },
  selectedItem: { borderColor: '#1458b8' },
  avatarImage: { width: '100%', height: '100%' },
  checkOverlay: { position: 'absolute', top: 5, right: 5, backgroundColor: '#fff', borderRadius: 12 },
  footer: { padding: 20, backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#e2e8f0' },
  confirmButton: { backgroundColor: '#1458b8', borderRadius: 14, paddingVertical: 16, alignItems: 'center', elevation: 4, shadowColor: '#1458b8', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8 },
