...
export default function AssistantScreen() {
  ...
  const sendMessage = async (text) => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'assistant', text: data.answer || "I'm having trouble retrieving that information right now." }]);
    } catch (error) {
...
const styles = StyleSheet.create({
  ...
  sendButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#1458b8', alignItems: 'center', justifyContent: 'center', marginLeft: 8 },
});
