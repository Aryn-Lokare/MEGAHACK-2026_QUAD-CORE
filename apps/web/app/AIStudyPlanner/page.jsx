          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 h-fit min-h-[600px] flex flex-col">
            ...
            <div className="flex-1 overflow-auto">
              {!plan && !loading ? (
                ...
                <div className="prose prose-slate prose-indigo max-w-none text-sm leading-relaxed prose-h3:text-indigo-600 prose-h3:mt-6 prose-h3:mb-2 prose-strong:text-slate-900 prose-ul:my-2 prose-li:my-0.5 whitespace-pre-wrap">
